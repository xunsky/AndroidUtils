...
public final class SpannableUtils {
     ...
     *             </ul>
     * @return {@link SpannableUtils}
     */
    public SpannableUtils setFlag(final int flag) {
        this.flag = flag;
        return this;
    }
     ...
     * @return {@link SpannableUtils}
     */
    public SpannableUtils setForegroundColor(@ColorInt final int color) {
     ...
     * @return {@link SpannableUtils}
     */
    public SpannableUtils setBackgroundColor(@ColorInt final int color) {
     ...
     * @return {@link SpannableUtils}
     */
    public SpannableUtils setLineHeight(@IntRange(from = 0) final int lineHeight) {
     ...
     * @return {@link SpannableUtils}
     */
    public SpannableUtils setLineHeight(@IntRange(from = 0) final int lineHeight, @Align final int align) {
     ...
     * @return {@link SpannableUtils}
     */
    public SpannableUtils setQuoteColor(@ColorInt final int color) {
     ...
     * @return {@link SpannableUtils}
     */
    public SpannableUtils setQuoteColor(@ColorInt final int color, @IntRange(from = 1) final int stripeWidth, @IntRange(from = 0) final int gapWidth) {
     ...
     * @return {@link SpannableUtils}
     */
    public SpannableUtils setLeadingMargin(@IntRange(from = 0) final int first, @IntRange(from = 0) final int rest) {
        this.first = first;
        this.rest = rest;
        return this;
    }
     ...
     * @return {@link SpannableUtils}
     */
    public SpannableUtils setBullet(@IntRange(from = 0) final int gapWidth) {
     ...
     * @return {@link SpannableUtils}
     */
    public SpannableUtils setBullet(@ColorInt final int color, @IntRange(from = 0) final int radius, @IntRange(from = 0) final int gapWidth) {
     ...
     * @return {@link SpannableUtils}
     */
    public SpannableUtils setIconMargin(final Bitmap bitmap) {
     ...
     * @return {@link SpannableUtils}
     */
    public SpannableUtils setIconMargin(final Bitmap bitmap, final int gapWidth, @Align final int align) {
     ...
     * @return {@link SpannableUtils}
     */
    public SpannableUtils setIconMargin(final Drawable drawable) {
     ...
     * @return {@link SpannableUtils}
     */
    public SpannableUtils setIconMargin(final Drawable drawable, final int gapWidth, @Align final int align) {
     ...
     * @return {@link SpannableUtils}
     */
    public SpannableUtils setIconMargin(final Uri uri) {
     ...
     * @return {@link SpannableUtils}
     */
    public SpannableUtils setIconMargin(final Uri uri, final int gapWidth, @Align final int align) {
     ...
     * @return {@link SpannableUtils}
     */
    public SpannableUtils setIconMargin(@DrawableRes final int resourceId) {
     ...
     * @return {@link SpannableUtils}
     */
    public SpannableUtils setIconMargin(@DrawableRes final int resourceId, final int gapWidth, @Align final int align) {
     ...
     * @return {@link SpannableUtils}
     */
    public SpannableUtils setFontSize(@IntRange(from = 0) final int size) {
     ...
     * @return {@link SpannableUtils}
     */
    public SpannableUtils setFontSize(@IntRange(from = 0) final int size, final boolean isDp) {
        this.fontSize = size;
     ...
     * @return {@link SpannableUtils}
     */
    public SpannableUtils setFontProportion(@FloatRange(from = 0, fromInclusive = false) final float proportion) {
     ...
     * @return {@link SpannableUtils}
     */
    public SpannableUtils setFontXProportion(@FloatRange(from = 0, fromInclusive = false) final float proportion) {
     ...
     * @return {@link SpannableUtils}
     */
    public SpannableUtils setStrikethrough() {
     ...
     * @return {@link SpannableUtils}
     */
    public SpannableUtils setUnderline() {
     ...
     * @return {@link SpannableUtils}
     */
    public SpannableUtils setSuperscript() {
     ...
     * @return {@link SpannableUtils}
     */
    public SpannableUtils setSubscript() {
     ...
     * @return {@link SpannableUtils}
     */
    public SpannableUtils setItalic() {
        isItalic = true;
        return this;
    }
     ...
     * @return {@link SpannableUtils}
     */
    public SpannableUtils setBoldItalic() {
        isBoldItalic = true;
        return this;
    }
     ...
     * @return {@link SpannableUtils}
     */
    public SpannableUtils setFontFamily(@NonNull final String fontFamily) {
     ...
     * @return {@link SpannableUtils}
     */
    public SpannableUtils setTypeface(@NonNull final Typeface typeface) {
     ...
     * @return {@link SpannableUtils}
     */
    public SpannableUtils setAlign(@NonNull final Alignment alignment) {
     ...
     * @return {@link SpannableUtils}
     */
    public SpannableUtils setClickSpan(@NonNull final ClickableSpan clickSpan) {
     ...
     * @return {@link SpannableUtils}
     */
    public SpannableUtils setUrl(@NonNull final String url) {
        this.url = url;
        return this;
    }
     ...
     * @return {@link SpannableUtils}
     */
    public SpannableUtils setBlur(@FloatRange(from = 0, fromInclusive = false) final float radius, final Blur style) {
     ...
     * @return {@link SpannableUtils}
     */
    public SpannableUtils setShader(@NonNull final Shader shader) {
        this.shader = shader;
        return this;
    }
     ...
     * @return {@link SpannableUtils}
     */
    public SpannableUtils setShadow(@FloatRange(from = 0, fromInclusive = false) final float radius,
                                    final float dx,
                                    final float dy,
     ...
     * @return {@link SpannableUtils}
     */
    public SpannableUtils setSpans(@NonNull final Object... spans) {
        if (spans.length > 0) {
            this.spans = spans;
        }
        return this;
     ...
     * @return {@link SpannableUtils}
     */
    public SpannableUtils append(@NonNull final CharSequence text) {
     ...
     * @return {@link SpannableUtils}
     */
    public SpannableUtils appendLine() {
        apply(mTypeCharSequence);
     ...
     * @return {@link SpannableUtils}
     */
    public SpannableUtils appendLine(@NonNull final CharSequence text) {
        apply(mTypeCharSequence);
     ...
     * @return {@link SpannableUtils}
     */
    public SpannableUtils appendImage(@NonNull final Bitmap bitmap) {
     ...
     * @return {@link SpannableUtils}
     */
    public SpannableUtils appendImage(@NonNull final Bitmap bitmap, @Align final int align) {
        apply(mTypeImage);
     ...
     * @return {@link SpannableUtils}
     */
    public SpannableUtils appendImage(@NonNull final Drawable drawable) {
     ...
     * @return {@link SpannableUtils}
     */
    public SpannableUtils appendImage(@NonNull final Drawable drawable, @Align final int align) {
        apply(mTypeImage);
     ...
     * @return {@link SpannableUtils}
     */
    public SpannableUtils appendImage(@NonNull final Uri uri) {
     ...
     * @return {@link SpannableUtils}
     */
    public SpannableUtils appendImage(@NonNull final Uri uri, @Align final int align) {
        apply(mTypeImage);
        this.imageUri = uri;
        this.alignImage = align;
        return this;
     ...
     * @return {@link SpannableUtils}
     */
    public SpannableUtils appendImage(@DrawableRes final int resourceId) {
     ...
     * @return {@link SpannableUtils}
     */
    public SpannableUtils appendImage(@DrawableRes final int resourceId, @Align final int align) {
        apply(mTypeImage);
     ...
     * @return {@link SpannableUtils}
     */
    public SpannableUtils appendSpace(@IntRange(from = 0) final int size) {
     ...
     * @return {@link SpannableUtils}
     */
    public SpannableUtils appendSpace(@IntRange(from = 0) final int size, @ColorInt final int color) {
        apply(mTypeSpace);
        spaceSize = size;
        spaceColor = color;
        return this;
    ...
    class CustomIconMarginSpan implements LeadingMarginSpan, android.text.style.LineHeightSpan {
        ...
        private Bitmap resource2Bitmap(final int resourceId) {
            Drawable drawable = ContextCompat.getDrawable(ContextProvider.get(), resourceId);
    ...
    class CustomImageSpan extends CustomDynamicDrawableSpan {
        ...
        private CustomImageSpan(final Bitmap b, final int verticalAlignment) {
            ...
            mDrawable = new BitmapDrawable(ContextProvider.get().getResources(), b);
        ...
        public Drawable getDrawable() {
            ...
            if (mDrawable != null) {
                ...
                Bitmap bitmap;
                try {
                    InputStream is = ContextProvider.get().getContentResolver().openInputStream(mContentUri);
                    bitmap = BitmapFactory.decodeStream(is);
                    drawable = new BitmapDrawable(ContextProvider.get().getResources(), bitmap);
                    drawable.setBounds(0, 0, drawable.getIntrinsicWidth(), drawable.getIntrinsicHeight());
                    if (is != null) {
                        is.close();
                    }
                ...
                try {
                    drawable = ContextCompat.getDrawable(ContextProvider.get(), mResourceId);
                    drawable.setBounds(0, 0, drawable.getIntrinsicWidth(), drawable.getIntrinsicHeight());
                } catch (Exception e) {
