...
public class PathUtils {
    ...
    public static String getInternalAppDataPath() {
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.N) {
            return ContextProvider.get().getApplicationInfo().dataDir;
        }
        return getAbsolutePath(ContextProvider.get().getDataDir());
    }
    ...
    public static String getInternalAppCodeCacheDir() {
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.LOLLIPOP) {
            return ContextProvider.get().getApplicationInfo().dataDir + "/code_cache";
        }
        return getAbsolutePath(ContextProvider.get().getCodeCacheDir());
    }
    ...
    public static String getInternalAppCachePath() {
        return getAbsolutePath(ContextProvider.get().getCacheDir());
    }
    ...
    public static String getInternalAppDbsPath() {
        return ContextProvider.get().getApplicationInfo().dataDir + "/databases";
    }
    ...
    public static String getInternalAppDbPath(String name) {
        return getAbsolutePath(ContextProvider.get().getDatabasePath(name));
    }
    ...
    public static String getInternalAppFilesPath() {
        return getAbsolutePath(ContextProvider.get().getFilesDir());
    }
    ...
    public static String getInternalAppSpPath() {
        return ContextProvider.get().getApplicationInfo().dataDir + "shared_prefs";
    }
    ...
    public static String getInternalAppNoBackupFilesPath() {
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.LOLLIPOP) {
            return ContextProvider.get().getApplicationInfo().dataDir + "no_backup";
        }
        return getAbsolutePath(ContextProvider.get().getNoBackupFilesDir());
    }
    ...
    public static String getExternalAppCachePath() {
        if (isExternalStorageDisable()) return "";
        return getAbsolutePath(ContextProvider.get().getExternalCacheDir());
    }
    ...
    public static String getExternalAppFilesPath() {
        if (isExternalStorageDisable()) return "";
        return getAbsolutePath(ContextProvider.get().getExternalFilesDir(null));
    }
    ...
    public static String getExternalAppMusicPath() {
        if (isExternalStorageDisable()) return "";
        return getAbsolutePath(ContextProvider.get().getExternalFilesDir(Environment.DIRECTORY_MUSIC));
    }
    ...
    public static String getExternalAppPodcastsPath() {
        if (isExternalStorageDisable()) return "";
        return getAbsolutePath(ContextProvider.get().getExternalFilesDir(Environment.DIRECTORY_PODCASTS));
    }
    ...
    public static String getExternalAppRingtonesPath() {
        if (isExternalStorageDisable()) return "";
        return getAbsolutePath(ContextProvider.get().getExternalFilesDir(Environment.DIRECTORY_RINGTONES));
    }
    ...
    public static String getExternalAppAlarmsPath() {
        if (isExternalStorageDisable()) return "";
        return getAbsolutePath(ContextProvider.get().getExternalFilesDir(Environment.DIRECTORY_ALARMS));
    }
    ...
    public static String getExternalAppNotificationsPath() {
        if (isExternalStorageDisable()) return "";
        return getAbsolutePath(ContextProvider.get().getExternalFilesDir(Environment.DIRECTORY_NOTIFICATIONS));
    }
    ...
    public static String getExternalAppPicturesPath() {
        if (isExternalStorageDisable()) return "";
        return getAbsolutePath(ContextProvider.get().getExternalFilesDir(Environment.DIRECTORY_PICTURES));
    }
    ...
    public static String getExternalAppMoviesPath() {
        if (isExternalStorageDisable()) return "";
        return getAbsolutePath(ContextProvider.get().getExternalFilesDir(Environment.DIRECTORY_MOVIES));
    }
    ...
    public static String getExternalAppDownloadPath() {
        if (isExternalStorageDisable()) return "";
        return getAbsolutePath(ContextProvider.get().getExternalFilesDir(Environment.DIRECTORY_DOWNLOADS));
    }
    ...
    public static String getExternalAppDcimPath() {
        if (isExternalStorageDisable()) return "";
        return getAbsolutePath(ContextProvider.get().getExternalFilesDir(Environment.DIRECTORY_DCIM));
    }
    ...
    public static String getExternalAppDocumentsPath() {
        if (isExternalStorageDisable()) return "";
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.KITKAT) {
            return getAbsolutePath(ContextProvider.get().getExternalFilesDir(null)) + "/Documents";
        }
        return getAbsolutePath(ContextProvider.get().getExternalFilesDir(Environment.DIRECTORY_DOCUMENTS));
    }
    ...
    public static String getExternalAppObbPath() {
        if (isExternalStorageDisable()) return "";
        return getAbsolutePath(ContextProvider.get().getObbDir());
    }
